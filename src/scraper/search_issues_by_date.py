    ...
    return """
{
  ...
  search(query: "Android created:DATE language:Java is:closed is:issue linked:pr sort:reactions", type: ISSUE, first: 30, after: AFTER) {
...
if __name__ == "__main__":
    ...
    fileName = "android_closed_issues_" + str_start_date + "_" + str_end_date + "_java.md"
