    ...
    return """
{
  ...
  search(query: " '''duplicate of #''' in:comments is:issue repo:jquery/jquery-mobile", type: ISSUE, first: 100, after: AFTER) {
...
if __name__ == "__main__":
    ...
    end_date = datetime.date(2020, 1, 1)  # datetime.date.today()
    ...
    fileName = "test_data_issues_" + str_start_date + "_" + str_end_date + ".md"
